...
## 1. The model: a registry + slot components
...
## 2. Step 1 — one `<VeltWireframe>` root
...
## 3. Step 2 — fill a feature's slots with your layout
...
**You only fill the slots you care about — a slot you never declare falls back to Velt's default.** This means you can do a tiny override (just the empty state) or a near‑total rebuild (overriding 40+ slots across the dialog/sidebar).
...
## What wireframes can and can't do
