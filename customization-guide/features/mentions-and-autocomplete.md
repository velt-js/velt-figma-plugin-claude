...
## Customize the data (the most common need) — on `<VeltComments>`
...
> ⚠️ These props do **not** exist: `showMentionGroups`, `customGroups`, `atHere`/`showAtHere`. Use the real names above.
