...
| `onAutocompleteChipClick()` | `Observable<AutocompleteChipData \| null>` | Callback on autocomplete chip click. |
...
| Method | Returns | Description |
|---|---|---|
| `getAllTagAnnotations(documentId?: string, location?: Location)` | `Observable<TagAnnotation[] \| null>` | Subscribe to tags on the current document. |
...
| `setLiveStateData<T = unknown>(liveStateDataId: string, liveStateData: T)` | `Promise<void>` | Set live state data. |
