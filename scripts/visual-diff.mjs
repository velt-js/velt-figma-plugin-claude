...
export function cropImage(img, x, y, w, h) {
  ...
  // Clamp to >= 0. A box whose origin lands past the image edge (padded diff geometry vs a
  // smaller live capture) previously produced a negative size and crashed Buffer.alloc.
