...
## The model — you do the composition

A primitive is a **normal React component** that renders a Velt custom element (`<velt-…>`). Examples: `VeltComments`, `VeltCommentDialog`, `VeltCommentsSidebar`, `VeltCommentBubble`, `VeltCommentText`, `VeltNotificationsPanel`, `VeltReactionTool` — plus a sub‑component for nearly every child.
...
## What primitives can and can't do
