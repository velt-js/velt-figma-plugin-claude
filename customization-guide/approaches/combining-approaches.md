# Approach · Combining approaches (mix‑and‑match)
...
List your features, run the [decision tree](../02-decision-tree.md) on each, record the result:
...
- ❌ **Headless for a feature a wireframe could do.** Unnecessary maintenance — see [`headless.md`](./headless.md).
